...
def test_clean_codes():
    ...
    raw = pd.DataFrame({'Category 1': {0: 'INDICATORS', 1: 'INDICATORS', 2: 'INDICATORS'},
                        ...
                        'Indicator name': {0: 'Current Health Expenditure (CHE) as % Gross Domestic Product (GDP)',
    ...
    expected = pd.DataFrame({'category_1': {0: 'INDICATORS', 1: 'INDICATORS', 2: 'INDICATORS'},
                             'category_2': {0: 'AGGREGATES', 1: 'AGGREGATES', 2: 'AGGREGATES'},
                             'indicator_code': {0: 'che_gdp', 1: 'che_pc_usd', 2: 'che_pc_ppp'},
                             'indicator_name': {0: 'Current Health Expenditure (CHE) as % Gross Domestic Product (GDP)',
                                                1: 'Current Health Expenditure (CHE) per Capita in US$',
                                                2: 'Current Health Expenditure (CHE) per Capita in PPP'},
...
def test_clean_data():
    ...
    raw = pd.DataFrame({'country': {0: 'Algeria', 1: 'Algeria', 2: 'Algeria'},
                        ...
                        'che_pc_usd': {0: 61.58218002000001,
                                       1: 66.80211639000001,
                                       2: 66.46335601999999}})

    expected = pd.DataFrame({'country_name': {0: 'Algeria',
                                              1: 'Algeria',
                                              2: 'Algeria',
                                              3: 'Algeria',
                                              4: 'Algeria',
                                              5: 'Algeria'},
                             'country_code': {0: 'DZA', 1: 'DZA', 2: 'DZA', 3: 'DZA', 4: 'DZA', 5: 'DZA'},
                             'region': {0: 'AFR', 1: 'AFR', 2: 'AFR', 3: 'AFR', 4: 'AFR', 5: 'AFR'},
                             'income_group': {0: 'Low-Mid',
                                              1: 'Low-Mid',
                                              2: 'Low-Mid',
                                              3: 'Low-Mid',
                                              4: 'Low-Mid',
...
def test_clean_metadata():
    ...
    raw = pd.DataFrame({'country': {0: 'Algeria', 1: 'Algeria', 2: 'Algeria'},
                        ...
                        'Indicator name': {0: 'Current health expenditure by revenues of health care financing schemes',
    ...
    expected = pd.DataFrame({'country_code': {0: 'DZA', 1: 'DZA', 2: 'DZA'},
                             'indicator_code': {0: 'fs', 1: 'fs1', 2: 'fs11'},
                             'source': {0: nan,
                                        1: '2000 - 2019: Calculated as the difference between HF.1.1 and FS.2',
                                        2: '2000 - 2019: Calculated as the difference between HF.1.1 and FS.2'},
                             'comments': {0: nan, 1: nan, 2: nan},
                             'methods_of_estimation': {0: nan,
                                                       1: '2000 - 2019: Derived by applying the sum of the components',
                                                       2: '2000 - 2019: Derived by applying the sum of the components'},
                             'data_type': {0: nan,
                                           1: '2000 - 2019: Estimated',
