...
from bblocks.importers.who.ghed import GHED, URL
...
@mock.patch("bblocks.importers.who.ghed.Path.exists", return_value=True)
...
@mock.patch("bblocks.importers.who.ghed.Path.exists", return_value=False)
...
@mock.patch("bblocks.importers.who.ghed.requests.get")
...
@mock.patch("bblocks.importers.who.ghed.Path.open", side_effect=IOError)
...
@mock.patch("bblocks.importers.who.ghed.GHED._extract_raw_data")
...
@mock.patch("bblocks.importers.who.ghed.GHED._read_local_data")
...
@mock.patch("bblocks.importers.who.ghed.Path.exists", return_value=True)
@mock.patch("bblocks.importers.who.ghed.open", new_callable=mock.mock_open)
...
@mock.patch("bblocks.importers.who.ghed.GHED._load_data")
@mock.patch("bblocks.importers.who.ghed.Path.exists", return_value=True)
@mock.patch("bblocks.importers.who.ghed.open", new_callable=mock.mock_open)
